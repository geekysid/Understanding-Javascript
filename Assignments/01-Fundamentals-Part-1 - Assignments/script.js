...
// == for now)
if (numNeighbours == 1) {
    console.log(`2. Only 1 border!`);
}

// 3. Use an else-if block to log 'More than 1 border' in case 'numNeighbours'
// is greater than 1
if (numNeighbours == 1) {
    console.log(`3. Only 1 border!`);
} else if (numNeighbours > 1) {
    console.log(`3. More then 1 border`);
}

// 4. Use an else block to log 'No borders' (this block will be executed when
// 'numNeighbours' is 0 or any other value)
if (numNeighbours == 1) {
    console.log(`4. Only 1 border!`);
} else if (numNeighbours > 1) {
    console.log(`4. More then 1 border`);
} else {
...
// is this happening?
if (numNeighbours === 1) {
    console.log(`6. Only 1 border!`);
} else {
    console.log(`6. Border is not 1!`);
}
// Because javascript n more implicity converts string to number and hence notypecoercion happens.

// 7. Finally, convert 'numNeighbours' to a number, and watch what happens now
// when you input 1
numNeighbours = Number(numNeighbours);
if (numNeighbours === 1) {
    console.log(`7. Only 1 border!`);
}
...
// Canada :D)
let new_country = 'Canada'
let new_population = 1300;
if (language === "English" && new_population < 50000000 && !(isIsland)) {
...
let message = (population > 33000) ? `${country}'s population is above average.` : `${country}'s population is below average.`;
console.log(message);

// 2. After checking the result, change the population temporarily to 13 and then to 130.
// See the different results, and set the population back to original
population = 2200;
message = (population > 33000) ? `${country}'s population is above average.` : `${country}'s population is below average.`;
console.log(message);
